            ...
            <nav class="navbar navbar-expand-lg fixed-top navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="contact2.jsp" class="nav-item nav-link active">Contact Us</a>
        ...
        <!-- Navbar & Hero End -->
         ...
         <div class="container-fluid bg-breadcrumb">
            ...
            <div class="container text-center py-5" style="max-width: 900px;">
                <h3 class="display-3 mb-4 wow fadeInDown" data-wow-delay="0.1s">Contact</h1>
        ...
        <div class="container-fluid contact py-5">
            <div class="container py-5">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 900px;">
					...
					<p class="mb-0">Experience hassle-free laundry management with WashIt. Our efficient and user-friendly service ensures your clothes are handled with care, giving you more time to focus on what truly matters. Say goodbye to laundry day stress and hello to fresh, clean clothes at your convenience.</p>
                    </p>
                </div>
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.1s">
                        <h2 class="display-5 mb-5">Our Contact Form</h2>
                        <form>
                            <div class="row g-3">
                    ...
                    <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.3s">
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div class="ms-4">
                                <h4>Addresses</h4>
                                <p class="mb-0">Oslo House, Vadodara, Gujarat</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div class="ms-4">
                                <h4>Addresses</h4>
                                <p class="mb-0">Karelibaug, Vadodara, Gujarat</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center mb-4">
                        ...
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div class="ms-4">
                                <h4>Email</h4>
                                <p class="mb-0">harshtutorials127@gmail.com</p>
                                <p class="mb-0">harshtutorials127@gmail.com</p>
                            </div>
                        </div>
                    ...
                    <div class="col-12 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="rounded h-100">
                            ...
                            style="height: 500px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d58612.51727223179!2d71.1823868!3d23.013705!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395a2ab850611bf3%3A0x4ee9eb2bf06fa337!2sHalvad%2C%20Gujarat%2C%20India!5e0!3m2!1sen!2sbd!4v1694259649153!5m2!1sen!2sbd" 
