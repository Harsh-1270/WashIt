...
<body>
    ...
    <div class="container login-container">
        <form class="login-form" action="LaundryPersonLoginServlet" method="post">
            
            <h2 class="text-center" id="laundrylabel">LAUNDRY LOGIN</h2>
            ...
            <p class="text-center mb-0">Don't have an Account? <a href="laundarysignup.jsp">Sign Up</a></p>
        </form>
        <script>
            function validate() {
