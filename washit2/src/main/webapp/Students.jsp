        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="Students.jsp" class="nav-item nav-link active"><i class="fa fa-user-graduate me-2"></i>Students</a>
...
<body>
    <h2 style="text-align:left;">Students Details</h2>
    <table class="table table-bordered table-custom">
        ...
        <%
            ...
            try {
                ...
                String sql = "SELECT first_name, last_name, hostel,roomno,contact FROM students";
