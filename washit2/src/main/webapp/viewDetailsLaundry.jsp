        ...
        <!-- Navbar & Hero End -->
         ...
         <div class="container-fluid bg-breadcrumb">
            ...
            <div class="container text-center py-5" style="max-width: 900px;">
                <h3 class="display-3 mb-4 wow fadeInDown" data-wow-delay="0.1s">View Order</h1>
                <ol class="breadcrumb justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                    <li class="breadcrumb-item"><a href="index.jsp">Home</a></li>
                    <li class="breadcrumb-item  text-primary">Manage Order</li>
                    <li class="breadcrumb-item active text-primary">View Order</li>
                </ol>    
            </div>
        </div>
        <!-- Header End -->
...
<%
    ...
    Integer studentId = (Integer) currentSession1.getAttribute("student_id");

    String orderIdParam = request.getParameter("id");
    Integer orderId = (orderIdParam != null) ? Integer.parseInt(orderIdParam) : null;
    ...
    try {
        ...
        String query = "SELECT o.id, o.shirts, o.tshirts, o.pants, o.trousers, o.shorts " +
                       "FROM orders o " +
                       "JOIN students s ON o.student_id = s.id " +
                       "WHERE o.student_id = ? AND o.id = ?";
        ...
        while (resultSet.next()) {
            Order order = new Order(
                resultSet.getInt("id"),
                resultSet.getInt("shirts"),
                resultSet.getInt("tshirts"),
                resultSet.getInt("pants"),
                resultSet.getInt("trousers"),
                resultSet.getInt("shorts")
            );
            orders.add(order);
        }
                ...
                <div class="row g-5">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="RotateMoveLeft">
                            <img src="img/laundry-2.png" class="img-fluid w-100" alt="" style="margin-top: -120px;">
                        </div>
                    </div>
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                        <h4 class="mb-4 text-primary">View Order</h4> 
