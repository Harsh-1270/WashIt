        ...
        <!-- Navbar & Hero End -->
         ...
         <div class="container-fluid bg-breadcrumb">
            ...
            <div class="container text-center py-5" style="max-width: 900px;">
                <h3 class="display-3 mb-4 wow fadeInDown" data-wow-delay="0.1s">Edit Order</h1>
                <ol class="breadcrumb justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                    <li class="breadcrumb-item"><a href="index.jsp">Home</a></li>
                    <li class="breadcrumb-item  text-primary">Order History</li>
                    <li class="breadcrumb-item active text-primary">Edit Order</li>
                </ol>    
            </div>
        </div>
        <!-- Header End -->
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                        <h4 class="mb-4 text-primary">Edit Order</h4> 
                            ...
                            <div class="container" style="max-width: 1000px;"> 
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 d-flex align-items-center mt-3">
                                        ...
                                        <span id="total" class="ms-2 fw-bold">0</span> 
                                    </div>
        
                                   <div class="col-lg-12 d-flex justify-content-center mt-4">
   									 <button type="submit" class="btn btn-primary rounded-pill py-3 px-5 place-order-btn">Update Order</button>
								   </div>
                                </div>
                            </div>
                        </form>
